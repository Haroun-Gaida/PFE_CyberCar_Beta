/**
 * @file CyberCar_ssd1306_display.c
 * @date 8-5-2026
 * @copyright Copyright (c) 2026
 *
 * @brief CyberCar Attack timeout or logging via SSD1306 display for user interface (optional)
 *
...
static const char *TAG = "CyberCar_display";
...
static void draw_standby_connected(int frame)
{
    ...
    u8g2_SetFont(&u8g2, u8g2_font_profont12_mr);
    u8g2_DrawStr(&u8g2, 4, 28, "CyberCar ONLINE");
...
{
    u8g2_DrawXBM(&u8g2, 0, 0, OLED_WIDTH, OLED_HEIGHT, epd_bitmap_CyberCar_logo);
}

static void CyberCar_display_task(void *pvParameters)
{
    (void)pvParameters;
    int matrix_frame = 0;
...
void CyberCar_display_init(void)
{
...
void CyberCar_display_set_attack_timeout(int timeout_sec)
{
