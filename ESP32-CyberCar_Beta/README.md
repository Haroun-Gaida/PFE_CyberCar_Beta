...
<div align="center">
<img src="resources/CyberCar_logo.png" alt="CyberCar-ESP Logo" width="350"/>
</div>

[![Stars](https://img.shields.io/github/stars/Haroun Gaida/ESP32-Deauther?style=for-the-badge&color=yellow)](https://github.com/Haroun Gaida/ESP32-Deauther/stargazers)
[![Forks](https://img.shields.io/github/forks/Haroun Gaida/ESP32-Deauther?style=for-the-badge&color=orange)](https://github.com/Haroun Gaida/ESP32-Deauther/network/members)
[![Issues](https://img.shields.io/github/issues/Haroun Gaida/ESP32-Deauther?style=for-the-badge&color=red)](https://github.com/Haroun Gaida/ESP32-Deauther/issues)
[![Pull Requests](https://img.shields.io/github/issues-pr/Haroun Gaida/ESP32-Deauther?style=for-the-badge&color=purple)](https://github.com/Haroun Gaida/ESP32-Deauther/pulls)
[![License](https://img.shields.io/github/license/Haroun Gaida/ESP32-Deauther?style=for-the-badge&color=blue)](LICENSE)
[![Last Commit](https://img.shields.io/github/last-commit/Haroun Gaida/ESP32-Deauther?style=for-the-badge&color=brightgreen)](https://github.com/Haroun Gaida/ESP32-Deauther/commits)
[![Repo Size](https://img.shields.io/github/repo-size/Haroun Gaida/ESP32-Deauther?style=for-the-badge&color=informational)](https://github.com/Haroun Gaida/ESP32-Deauther)
[![Contributors](https://img.shields.io/github/contributors/Haroun Gaida/ESP32-Deauther?style=for-the-badge&color=pink)](https://github.com/Haroun Gaida/ESP32-Deauther/graphs/contributors)

A wireless security research firmware for the ESP32 microcontroller. Built on top of [risinek's](https://github.com/risinek/esp32-wifi-penetration-tool) original ESP32 Wi-Fi penetration tool foundation, ProjectCyberCarOS extends the original with a redesigned web interface, multi-target deauthentication, BLE attack capabilities, a deauth attack detector, optional OLED display support, and several additional attack modules.
...
- Note: If you have a ESP32 S3 based version, look at the branch: `s3-N16R8` https://github.com/Haroun Gaida/ESP32-Deauther/tree/s3-N16R8
...
Advertises the ESP32 as a Bluetooth HID keyboard under the name "CyberCar-RandomNumber". When a Windows PC pairs with it, the firmware sends keystrokes to perform the payloads.
